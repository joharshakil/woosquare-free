               ...
               <article class="hentry prtn-article">
						...
						<div class="switchWrap">
							<div class="extonoffpp onoffswitch_<?php esc_html_e($key)?>">
							   ...
							   <label
								  ...
								  for="myonoffswitch_">
								  <span class="extonoff onoffswitch-inner_">Premium!</span>
                  ...
                  <div class="article-content">
                     ...
                     <!-- <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-primary videoBtn" 
                        data-toggle="modal" data-src="<?php echo esc_url($module['module_video'])?>" data-target="#myModal">
                     ...
                     <!-- <div class="extonoffpp onoffswitch_<?php esc_html_e($key)?>">
						<input type="checkbox" name="onoffswitch_<?php esc_html_e($key)?>" class="onoffswitch-checkbox_<?php esc_html_e($key)?> enable_plugin" id="myonoffswitch_<?php esc_html_e($key)?>" <?php if(!$module['module_activate'] == false){ echo 'checked'; } ?>>
						<label class="<?php if($module['module_activate']){ echo 'extonofflabel '; } ?>onoffswitch-label_<?php esc_html_e($key)?>" for="myonoffswitch_<?php esc_html_e($key)?>">
							<span class="extonoff onoffswitch-inner_<?php esc_html_e($key)?>"></span>
							<span class="extonoffouter onoffswitch-switch_<?php esc_html_e($key)?>"></span>
						</label>
					</div> -->
