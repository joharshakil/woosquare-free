			...
			<tbody>
				...
				<tr>
					<td>
						...
						<input type='radio' value="<?php esc_html_e($cards->id); ?>" id="saved_cards" class='saved_cards_squ' name="saved_cards" />
						<?php
						 
						switch ($cards->card_brand) {
							case "VISA":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) .'/img/cc-icon/visa.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "MASTERCARD":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/mastercard.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "DISCOVER":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/discover.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "DISCOVER_DINERS":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/discover.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "JCB":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/jcb.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "AMERICAN_EXPRESS":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/amex.svg'. '" alt="Amex" width="32" style="margin-left: 0.3em" />';
								break;
							case "CHINA_UNIONPAY":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/china_unionpay.png'. '" alt="china_unionpay" width="32" style="margin-left: 0.3em" />';
								break;
							case "OTHER_BRAND":
								echo '<img src="' . esc_html(WooSquare_PLUGIN_URL_PAYMENT) . '/img/cc-icon/china_unionpay.png'. '" alt="china_unionpay" width="32" style="margin-left: 0.3em" />';
								break;
					...
					<td><?php esc_html_e($cards->last_4); ?></td>
					<td><?php esc_html_e($cards->exp_month.'/'.$cards->exp_year); ?></td>
					<td></td>
				</tr>
				<?php } ?>
				<tr>
