                ...
                <div class="row m-t-20">
                    ...
                    <div class="col-md-8 text-right">
                        ...
                        <span class=" <?php echo sanitize_text_field($_GET['page']); ?>-2"
                            <?php if(!empty($woocommerce_square_plus_settings['enable_sandbox']) && @$woocommerce_square_plus_settings['enable_sandbox'] == 'yes'){ echo 'style="pointer-events:none;"'; } if ($currencyMismatchFlag): ?>
                            style="opacity:0.5;pointer-events:none;" <?php endif; ?>>

                          

                            <a <?php if(!empty($woocommerce_square_plus_settings['enable_sandbox']) && @$woocommerce_square_plus_settings['enable_sandbox'] == 'yes' ){ echo 'style="opacity: 0.5;"'; } ?>
